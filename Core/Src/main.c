...
/* Definitions for hardware_pollin */
osThreadId_t hardware_pollinHandle;
const osThreadAttr_t hardware_pollin_attributes = {
  .name = "hardware_pollin",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_start_hardware_polling_task */
/**
* @brief Function implementing the hardware_pollin thread.
* @param argument: Not used
* @retval None
*/
